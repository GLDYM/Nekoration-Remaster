...
wooden_cn = ["深色橡木","蓝木","云杉木","诡异木","丛林木","绿木","魔法木","橡木","柳木","绯红木","金合欢木","红树木","暗影木","樱木","白桦木","棕榈木","","空气"]
woods = ["pumpkin","dark_oak","spruce","warped","jungle","oak","crimson","acacia","birch","mangrove"]
woods_cn = ["南瓜","深色橡木","云杉木","诡异木","丛林木","橡木","绯红木","金合欢木","白桦木","红树木"]
chair_us = "Chair"
table_us = "Table"
...
decors = ["awning_pure","awning_stripe","awning_pure_short","awning_stripe_short","easel_menu","easel_menu_white","glass_table","glass_round_table","arm_chair","bench","cabinet","drawer","drawer_chest","cupboard","shelf","wall_shelf"]
decors_us = ["%s Awning","%s Stripe Awning","Short %s Awning","Short %s Stripe Awning","%s Easel Menu","%s White Easel Menu","%s Glass Table","%s Round Glass Table","%s Arm Chair","%s Bench","%s Cabinet","%s Drawer","%s Chest of Drawers","%s Cupboard","%s Shelf","%s Wall Shelf"]
decors_cn = ["%s雨篷","%s条纹雨篷","%s短篷","%s条纹短篷","%s展架","%s白色展架","%s玻璃桌","%s玻璃圆桌","%s扶手椅","%s长椅","%s橱柜","%s抽屉","%s斗柜","%s壁橱","%s搁板","%s墙架"]
...
# [ENTITIES]
for ett in range(0, len(etts)):
    obj_us['entity.nekoration.' + etts[ett]] = etts_us[ett]
    obj_cn['entity.nekoration.' + etts[ett]] = etts_cn[ett]
