...
public class DyeableWoodenBlockItem extends BlockItem {
    ...
    public Component getName(ItemStack stack) {
        if (Thread.currentThread().getThreadGroup() == SidedThreadGroups.SERVER)
            ...
            return CaseTweak.getTweaked(Component.translatable(this.getDescriptionId(stack), (Component.translatable("color.wooden." + (hasColor(stack) ? getColor(stack).getSerializedName() : "unknown"))).getString()));
    }
}
