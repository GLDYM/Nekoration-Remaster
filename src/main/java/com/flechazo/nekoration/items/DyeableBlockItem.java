...
public class DyeableBlockItem extends BlockItem {
    ...
    public Component getName(ItemStack stack) {
        if (Thread.currentThread().getThreadGroup() == SidedThreadGroups.SERVER)
            ...
            return CaseTweak.getTweaked(Component.translatable(this.getDescriptionId(stack), (Component.translatable("color.nekoration." + (hasColor(stack) ? getColor(stack).getSerializedName() : "unknown"))).getString()));
    }
}
