...
import com.flechazo.nekoration.client.rendering.blockentities.PhonographRenderer;
...
public class RenderTypeHelper {
    ...
    private static final RenderType PAINTING_PIXELS = RenderType.create("painting_pixels", DefaultVertexFormat.POSITION_COLOR_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, false, RenderType.CompositeState.builder().setShaderState(PIXEL_SHADER).setTextureState(NO_TEXTURE).setCullState(NO_CULL).setLightmapState(ENABLE_LIGHTMAP).createCompositeState(false));
