...
public class ChunkModel {
    ...
    public void compile(Minecraft mc, BlockPos camPos) {
        ...
        for (RenderChunk chunk : chunks) {
            ...
            boolean isLightReady = lightEngine.hasLightWork() ||
                    lightEngine.lightOnInSection(SectionPos.of(chunk.getOrigin()));
            ...
            if (isLightReady) {
                ...
                isCompiled = true;
                LOGGER.info("Chunk model compilation at {} complete.", chunkpos);
            }
        }
