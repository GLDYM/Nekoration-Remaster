...
public final class NekorationItemTags {
    ...
    public static final TagKey<Item> DRAWERS = create("furniture/drawers");
    public static final TagKey<Item> CABINETS = create("furniture/cabinets");
    public static final TagKey<Item> DRAWER_CHESTS = create("furniture/drawer_chests");
